                        ...
                        GError **error)
{
    ...
    if (out_mime_type &&
        (content_type = g_content_type_guess (path, (const guchar *)data, len, NULL))) {
                        ...
                        GError **error)
{
    ...
    if (out_mime_type &&
        (content_type = g_content_type_guess (uri, (const guchar *)data, len, NULL))) {
        *out_mime_type = g_content_type_get_mime_type (content_type);
        g_free (content_type);
    }
